...
const FilterMemoryHeader: React.FC = () => {
    ...
    return (
        <View style={styles.header}>
            <SafeAreaView style={styles.elementsContainer}>
                ...
                <Text style={styles.title}><Image source={require('../../../../assets/filter-icons/filter.png')}  style={{ width : 20, height : 20}}/>  Filter </Text>
...
export default FilterMemoryHeader;
